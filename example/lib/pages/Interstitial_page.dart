                  ...
                  (ret) {
                    switch (ret.action) {
                      case IosZjEventAction.onAdLoaded:
                        print('插屏广告加载了${ret.extra}');
                        // 竞价成功
                      // ZjsdkFlutter.interstitialAdOnBidSuccess(100, 90);
                     
                        break;
                      case IosZjEventAction.onAdError:
                        print('插屏广告报错');
                        // 竞价失败
                      // IosZjBidInfo bidInfo = IosZjBidInfo();
                      // bidInfo.adTitle = "hello";
                      // ZjsdkFlutter.interstitialAdOnBidFailed(bidInfo); 
                        break;
