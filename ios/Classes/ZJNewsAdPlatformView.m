...
- (void)zj_newsAdDidLoad:(ZJNewsAd *)newsAd
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:NEWS_AD action:ZJSDKFlutterPluginOnAdLoadedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:[ZJPlatformTool mapToString:param]];
}
...
- (void)zj_newsAd:(ZJNewsAd *)newsAd didLoadFailWithError:(NSError * _Nullable)error
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:NEWS_AD action:ZJSDKFlutterPluginOnAdErrorAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NEWS_AD action:ZJSDKFlutterPluginOnAdShowAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NEWS_AD action:ZJSDKFlutterPluginOnAdRewardAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NEWS_AD action:ZJSDKFlutterPluginOnAdClickAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
