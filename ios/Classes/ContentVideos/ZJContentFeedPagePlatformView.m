//
//  ZJContentFeedPagePlatformView.m
//  zjsdk_flutter
//
...
@interface ZJContentFeedPagePlatformView()<FlutterStreamHandler>
...
@implementation ZJContentFeedPagePlatformView
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super init]) {
        ...
        //强持有避免立刻释放
        self.contentPage = [[ZJFeedPage alloc]initWithPlacementId:adId];
...
@interface ZJContentFeedPagePlatformViewFactory()
@property (nonatomic, strong) NSObject<FlutterPluginRegistrar> *registrar;
@end

@implementation ZJContentFeedPagePlatformViewFactory
...
- (NSObject<FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id)args {
    return [[ZJContentFeedPagePlatformView alloc] initWithFrame:frame viewIdentifier:viewId arguments:args registrar:_registrar];
}
@end
