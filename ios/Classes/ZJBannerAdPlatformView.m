...
- (void)zj_bannerAdDidLoad:(ZJBannerAd *)bannerAd
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdLoadedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:[ZJPlatformTool mapToString:param]];
...
- (void)zj_bannerAd:(ZJBannerAd *)bannerAd didLoadFailWithError:(NSError * _Nullable)error
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdLoadedAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdShowAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
- (void)zj_bannerAdDislike:(ZJBannerAd *)bannerAd
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdCloseAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdClickAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdCloseOtherControllerAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:BANNER action:ZJSDKFlutterPluginOnAdOpenOtherControllerAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
