...
// 以下是短剧使用的
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletLoadSuccessAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletLoadFailureAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletDetailUnlockFlowStartAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletDetailUnlockFlowCancelAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletDetailUnlockFlowEndAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletClickEnterViewAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletNextPlayletWillPlayAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnCurrentVideoChangedAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnDidClickedErrorButtonRetryAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnPlayletCloseButtonClickedAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnDataRefreshCompletionAction;
extern ZJSDKFlutterPluginAction const ZJSDKFlutterPluginOnViewControllerSwitchToIndexAction;
