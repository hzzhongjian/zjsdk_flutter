...
- (void)zj_feedFullVideoProviderLoadSuccess:(ZJFeedFullVideoProvider *)provider views:(NSArray<__kindof ZJFeedFullVideoView *> *)views
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdLoadedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:[ZJPlatformTool mapToString:param]];
}
...
- (void)zj_feedFullVideoProviderLoadFail:(ZJFeedFullVideoProvider *)provider error:(NSError *_Nullable)error
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdErrorAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdShowAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdDidPlayFinishAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdClickAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdOpenOtherControllerAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:DRAW_AD action:ZJSDKFlutterPluginOnAdCloseOtherControllerAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
