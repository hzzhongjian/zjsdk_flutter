...
{
    NSDictionary *param = @{
        @"ecpm":@(adsManager.eCPM)
    };
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdLoadedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:[ZJPlatformTool mapToString:param]];
...
- (void)ZJ_nativeExpressFeedAdManager:(ZJNativeExpressFeedAdManager *)adsManager didFailWithError:(NSError *_Nullable)error
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdErrorAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdShowAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdClickAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
/**
 *不喜欢该广告
 */
...
//        self.containerView = nil;
//    }
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdCloseAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
/**
 *展示落地页
 */
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdOpenOtherControllerAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
/**
 *关闭落地页
 */
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:NATIVE_EXPRESS action:ZJSDKFlutterPluginOnAdCloseOtherControllerAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
