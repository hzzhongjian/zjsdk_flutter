...
#import <zjsdk_flutter/zjsdk_flutter-Swift.h>
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletLoadFailureAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletDetailUnlockFlowStartAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}

/*! @abstract 解锁流程取消 */
- (void)zj_shortplayPlayletDetailUnlockFlowCancel:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletDetailUnlockFlowCancelAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    if (success) {
        [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletDetailUnlockFlowEndAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
    } else {
        [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletDetailUnlockFlowEndAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
    }
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletClickEnterViewAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}

/*! @abstract 本剧集观看完毕，切到下一部短剧回调 */
- (void)zj_shortplayNextPlayletWillPlay:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletNextPlayletWillPlayAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdLoadedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}

/*! @abstract 广告加载失败 */
- (void)zj_shortplayAdLoadFail:(id<ZJContentInfo>)content error:(NSError *)error
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdErrorAction viewId:(int)self.viewId code:(int)error.code msg:error.convertJSONString extra:@""];
}

/*! @abstract 广告填充失败 */
- (void)zj_shortplayAdFillFail:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdErrorAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_FAILURE msg:@"" extra:@""];
}

/*! @abstract 广告曝光 */
- (void)zj_shortplayAdWillShow:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdShowAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdClickAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
/*! @abstract 广告缓冲 */
...
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdDidPlayFinishAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}

/*! @abstract 激励视频广告跳过 */
- (void)zj_shortplayVideoRewardSkipEvent:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnAdClickSkipAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
- (void)zj_shortplayDrawVideoCurrentVideoChanged:(NSInteger)index adapter:(id<ZJContentInfo>)content
{
    ...
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnCurrentVideoChangedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:[ZJCommon mapToString:dict] extra:@""];
}

/*! @abstract 加载失败按钮点击重试回调 */
- (void)zj_shortplayDrawVideoDidClickedErrorButtonRetry:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnDidClickedErrorButtonRetryAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}

/*! @abstract 默认关闭按钮被点击的回调 */
- (void)zj_shortplayDrawVideoCloseButtonClicked:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnPlayletCloseButtonClickedAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}

/*! @abstract 数据刷新完成回调 */
- (void)zj_shortplayDrawVideoDataRefreshCompletion:(NSError *)error content:(id<ZJContentInfo>)content
{
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnDataRefreshCompletionAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:@"" extra:@""];
}
...
{
    NSDictionary *dict = @{@"index":@(index)};
    [ZjsdkFlutterPlugin sendMessageWithType:TUBE_AD action:ZJSDKFlutterPluginOnViewControllerSwitchToIndexAction viewId:(int)self.viewId code:ZJSDKFlutterPluginCode_SUCCESS msg:[ZJCommon mapToString:dict] extra:@""];
}
